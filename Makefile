...
workers:
	docker compose up --build worker-normalize worker-transaction worker-grouping worker-event-writer worker-alert worker-attachment worker-session worker-outcome
